...
# Download genomes
perl Scripts/parseGenomeList.pl Input_files/alphaproteobacteria.csv # Parse the NCBI genome table to get info to download genomes
...
sed -i 's/type_strain:_E19/E19/g' MLSA_final_alignment.fasta
