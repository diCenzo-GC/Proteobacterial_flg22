...
# Download genomes
perl Scripts/parseGenomeList.pl Input_files/Betaproteobacteria.csv # Parse the NCBI genome table to get info to download genomes
...
# flg22 in Achromobacter_denitrificans_ should be ERLSSGLRINSAKDDAAGMAIA - found to be at 37 to 58 characters
...
cut -c 37-58 sequence > flg22 #take out the flg22 sequence
